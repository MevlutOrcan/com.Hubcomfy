...
public class US_007_TC_003_NodeJs extends TestBaseRapor {
    ...
    public void TC_003() throws InterruptedException {
        ...
        extentTest = extentReports.createTest("US_007_TC_003", "NodeJs");
        ...
        us_005_006_007_page.brandsNodeJS.click();
        Assert.assertTrue(us_005_006_007_page.brandsNodeJS.isEnabled());
        extentTest.pass("11-Kullanici Product brands basligi altinda NodeJS drop down listeyi acip secer");
        Driver.closeDriver();
    }
