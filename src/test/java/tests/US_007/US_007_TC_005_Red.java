...
public class US_007_TC_005_Red extends TestBaseRapor {
    ...
    public void TC_005() throws InterruptedException {
        ...
        extentTest = extentReports.createTest("US_007_TC_005", "RED");
        ...
        us_005_006_007_page.brandsRed.click();
        Assert.assertTrue(us_005_006_007_page.brandsRed.isEnabled());
        extentTest.pass("11-Kullanici Product brands basligi altinda RED drop down listeyi acip secer");
        Driver.closeDriver();
    }
