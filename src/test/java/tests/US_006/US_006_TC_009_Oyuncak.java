...
public class US_006_TC_009_Oyuncak extends TestBaseRapor {
    ...
    public void TC_009() throws InterruptedException {
        ...
        extentTest = extentReports.createTest("US_006_TC_009", "Oyuncak");
        ...
        us_005_006_007_page.categoriesToysAndGames.click();
        Assert.assertTrue(us_005_006_007_page.categoriesToysAndGames.isEnabled());
        extentTest.pass("11-Kullanici Categories kisminda Oyuncak (Toys & Games) gorup secer");
        Driver.closeDriver();
    }
}
