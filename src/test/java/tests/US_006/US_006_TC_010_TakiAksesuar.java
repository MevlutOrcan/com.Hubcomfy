...
public class US_006_TC_010_TakiAksesuar extends TestBaseRapor {
    ...
    public void TC_010() throws InterruptedException {
        ...
        extentTest = extentReports.createTest("US_006_TC_010", "Taki & aksesuar ");
        ...
        us_005_006_007_page.categoriesAccessories.click();
        Assert.assertTrue(us_005_006_007_page.categoriesAccessories.isEnabled());
        extentTest.pass("11-Kullanici Categories kisminda Taki & aksesuar (Accessories) drop down secenegine basip alt listeyi gorur");
        Driver.closeDriver();
    }
