...
public class US_018_TC_002_OrderID extends TestBaseRapor {
    US_2_18_19_Page us_page = new US_2_18_19_Page();

    @Test
    public void test02OrderID() throws InterruptedException {
        extentTest = extentReports.createTest("Order ID;verilen urun numarası görülmeli");
        ...
        Assert.assertTrue(us_page.OrderID.isDisplayed());
        extentTest.pass("OrderID nin görünür olduğu doğrulanır");
        Driver.closeDriver();
